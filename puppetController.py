...
def dance(audio_path):
    ...
    while pygame.mixer.music.get_busy():
        ...
        # Check if music is still playing before sleeping
...
# Uncomment the following lines to test each scene function
    # scene_1()
    # time.sleep(2.0)
    # scene_2()
    # time.sleep(2.0)
    ...
    # Uncomment the following lines to test the dance function with different audio files
    # dance("puppetSounds/mtr_type_beat.mp3")
    #dance("puppetSounds/FREDIE_V_JASOM_SAMPLE.mp3")
    # dance("puppetSounds/nefarious.mp3")
    # dance("puppetSounds/prabhas_pierre.mp3")
    # dance("puppetSounds/slow.mp3")
    # dance("puppetSounds/soundcloudbeat_2.wav")
    time.sleep(1.0)
    send_angles([180,0,15,180,0])
    # Close connection
    # arduino.close()
